...
func NewGetOrderAlgos(param *GetOrderAlgosParam) (api.IRequest, api.IResponse) {
	return &api.Request{
		Path:   "/api/v5/trade/order-algo",
		Method: api.MethodGet,
		Param:  param,
	}, &GetOrderAlgosResponse{}
}

type GetOrderAlgosParam struct {
	AlgoId      string `url:"algoId,omitempty"`
	AlgoClOrdId string `url:"algoClOrdId,omitempty"`
}

type GetOrderAlgosResponse struct {
	api.Response
